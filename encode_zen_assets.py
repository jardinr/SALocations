...
categories = [
    {
        ...
        "specs": {
            "permitting": "Private Commercial Contract · Direct Venue Agreement (48-hr turnaround)",
    ...
    },
    {
        ...
        "gallery": [
            ...
            {"file": "Chapmans Peak (91).jpg", "source": "zen", "title": "Chapman's Peak: Dramatic Sunset Coastal Tarmac Run", "cat": "scouted"},
            {"file": "Chapmans Peak (57).jpg", "source": "zen", "title": "Chapman's Peak: Sweeping Cliff Curve Overlooking Hout Bay", "cat": "scouted"},
            {"file": "Chapmans Peak (71).jpg", "source": "zen", "title": "Chapman's Peak: Half-Tunnel Cantilever Pass & Sheer Mountain Wall", "cat": "scouted"},
            {"file": "Chapmans Peak (78).jpg", "source": "zen", "title": "Chapman's Peak: Elevated Lookout Vista over Horizon Ocean", "cat": "scouted"},
            {"file": "Chapmans Peak South Lookout (5).jpg", "source": "zen", "title": "South Lookout: Paved Staging Platform for Crane & Tracking Vehicles", "cat": "scouted"},
            {"file": "M6-to CB (0).jpg", "source": "zen", "title": "Victoria Road (M6): Coastal Approach Toward Twelve Apostles & Camps Bay", "cat": "scouted"},
            {"file": "M6-to CB (1).jpg", "source": "zen", "title": "Victoria Road: Coastal Tarmac Hugging Rocky Atlantic Shoreline", "cat": "scouted"},
            {"file": "M6-to CB (7).jpg", "source": "zen", "title": "Victoria Road: Open Ocean Highway Corridor for Camera Chase Vehicle", "cat": "scouted"}
        ]
    },
    {
        "id": "hero-house",
        ...
        "gallery": [
            ...
            {"file": "Amara Moon (2).jpg", "source": "zen", "title": "Amara Moon: Elevated Deck with Panoramic Atlantic Ocean Views", "cat": "scouted"},
            {"file": "Amara Moon (4).jpg", "source": "zen", "title": "Amara Moon: Contemporary Exterior Architecture Nestled into Slope", "cat": "scouted"},
            {"file": "Hexagon (4).jpg", "source": "zen", "title": "Hexagon House: Multi-Level Coastal Villa & Pool Terrace", "cat": "scouted"},
            {"file": "Hexagon (5).jpg", "source": "zen", "title": "Hexagon House: Outdoor Entertainment Terrace Overlooking Bay", "cat": "scouted"},
            {"file": "Hexagon (6).jpg", "source": "zen", "title": "Hexagon House: Light-Filled Living Room with Ocean Horizons", "cat": "scouted"},
            {"file": "Vicki (22).JPG", "source": "zen", "title": "Vicki Residence: Character Living Lounge with Warm Directional Light", "cat": "scouted"},
            {"file": "Rosemount Ave-Gardens (4).jpg", "source": "zen", "title": "Rosemount Ave: Heritage Cottage Facade with Mountain Backdrop in Gardens", "cat": "scouted"}
        ]
    },
    {
        ...
        "gallery": [
            ...
            {"file": "Deer Park (2).jpg", "source": "zen", "title": "Deer Park: Single-Track Trail under Pine Canopy Overlooking Cape Town", "cat": "scouted"},
            {"file": "Deer Park (24).jpg", "source": "zen", "title": "Deer Park: Forest Mountain Contour Path & Dirt Berms", "cat": "scouted"},
            {"file": "Lourensford trails (5).jpg", "source": "zen", "title": "Lourensford Trails: Wide Gravel Mountain Track with Mountain Peaks", "cat": "scouted"},
            {"file": "Lourensford trails (14).jpg", "source": "zen", "title": "Lourensford Trails: Flowing Single-Track Berm with Expansive Vistas", "cat": "scouted"}
        ]
    },
    {
        "id": "mountainside-shack",
        "num": "05",
        "title": "Mountainside Shack · Blackwood Cabin & Coastal Retreats",
        "icon": "🛖",
        "ref_heading": "Director's Visual Reference · Isolated Weathered Cabin on Wild Mountain Slope",
        "match_heading": "Cape Town Match · Blackwood Cabin / Monkey Valley / Imhoff's Gift",
        "match_score": "99% Match",
        "area": "Hout Bay / Noordhoek / Kommetjie Coastal Belt, Cape Town",
        "tagline": "Breathtaking off-grid timber cabins embedded in indigenous mountain forest canopies, featuring elevated stilt architecture, wooden boardwalk staircases, rock plunge pools, and dramatic mountain backdrops.",
        "creative_synopsis": "The director's references depict a remote, off-the-grid hideout — a weathered timber and stone cabin perched on a steep wild mountain slope beneath rocky crags. The newly curated Blackwood Cabin delivers an extraordinary, flawless match: a modern dark timber stilt cabin deep in a natural coastal forest canopy with an elevated wooden boardwalk staircase, paired with rustic double-storey timber decks, natural rock plunge pool, and panoramic mountain vistas. Additional options include Monkey Valley Nature Resort in Noordhoek and Imhoff's Gift in Kommetjie.",
        "ref_hero": "mountainside shack.jpg",
        "ref_hero_source": "ref",
        "ref_hero_title": "Director Reference: Isolated Off-Grid Cabin on Wild Coastal Mountain Slope",
        ...
        "key_features": [
            ...
            "Boardwalk Staircase: Dramatic elevated timber staircase winding through natural tree canopy — cinematic tracking shots",
            "Rock Plunge Pool: Natural stone-lined turquoise plunge pool set against mountain boulders and Strelitzia gardens",
            "Double-Storey Living: Timber cabin with upper sun deck, wood-burning stove, and towering eucalyptus backdrop",
            "Alternative Options: Monkey Valley treetop milkwood cabins (Noordhoek) & Imhoff's Gift wetland stone/timber retreat"
        ],
        "specs": {
            "permitting": "Private Property Commercial Agreement · Film-supportive management (48-hr turnaround)",
            "power": "On-site 3-phase grid power + domestic distribution tie-ins; silent generator staging area",
            "parking": "Spacious paved and gravel parking area for unit base, technical trucks, and catering",
            "sound_curfew": "Quiet coastal nature sanctuary · Pure birdsong, mountain breezes, and ocean surf ambience"
        },
        "gallery": [
            ...
            {"file": "Imhoff's Gift (18).jpg", "source": "zen", "title": "Imhoff's Gift: Secluded Coastal Wooden Retreat with Mountain Views", "cat": "scouted"},
            {"file": "Imhoff's Gift (20).jpg", "source": "zen", "title": "Imhoff's Gift: Timber & Stone Cabin Exterior in Fynbos Setting", "cat": "scouted"},
            {"file": "Imhoff's Gift (21).jpg", "source": "zen", "title": "Imhoff's Gift: Rustic Covered Deck Looking Over Wetlands & Mountains", "cat": "scouted"}
        ]
    },
    {
        "id": "nightclub-venue",
        ...
        "key_features": [
            ...
            "Beachfront lounge exterior & cocktail bar on Camps Bay strip (Café Caprice) featuring outdoor terrace, fluted timber counter & Veuve Clicquot lounge",
    ...
    },
    {
        ...
        "gallery": [
            ...
            {"file": "IMG_5256.JPG", "source": "zen", "title": "Woodstock Studio: Open Creative Floor Plan with Natural Window Daylight", "cat": "scouted"},
            {"file": "IMG_5253.JPG", "source": "zen", "title": "Woodstock Studio: High Industrial Walls & Structural Wooden Flooring", "cat": "scouted"},
            {"file": "IMG_5259.JPG", "source": "zen", "title": "Woodstock Studio: Exposed Brickwork & Overhead Industrial Beams", "cat": "scouted"},
            {"file": "Culver St (1).jpg", "source": "zen", "title": "Culver Street: Heritage Industrial Brick Factory Exterior in Salt River", "cat": "scouted"},
            {"file": "Culver St (2).jpg", "source": "zen", "title": "Culver Street: Industrial Facade with Wide Loading Access Doors", "cat": "scouted"},
            {"file": "Culver St (3).jpg", "source": "zen", "title": "Culver Street: Quiet Side-Street Staging for Unit Base & Trucks", "cat": "scouted"},
            {"file": "Chatham St (2).jpg", "source": "zen", "title": "Chatham Street: Urban Character Streetscape in Woodstock Creative District", "cat": "scouted"}
        ]
    },
    {
        "id": "shopping-centre",
        ...
        "gallery": [
            ...
            {"file": "V&A Waterfront (3).jpg", "source": "zen", "title": "V&A Waterfront: Pedestrian Shopping Promenade with Table Mountain", "cat": "scouted"},
            {"file": "V&A Waterfront (2).jpg", "source": "zen", "title": "V&A Waterfront: Historic Red Clock Tower & Harbor Quayside Walkway", "cat": "scouted"},
            {"file": "V&A Waterfront (31).jpg", "source": "zen", "title": "V&A Waterfront: Bustling Commercial Amphitheatre & Pedestrian Plaza", "cat": "scouted"},
            {"file": "V&A Waterfront (32).jpg", "source": "zen", "title": "V&A Waterfront: Open-Air Quayside Dining with Umbrella Seating", "cat": "scouted"},
            {"file": "V&A Waterfront (35).jpg", "source": "zen", "title": "V&A Waterfront: Colonnaded Walkway Overlooking Working Harbor", "cat": "scouted"}
        ]
    },
    {
        "id": "film-studios",
        ...
        "gallery": [
            {"file": "Roodebloem Studios (2).jpg", "source": "zen", "title": "Roodebloem Studios: Heritage Church Converted to High-End Daylight Film Studio", "cat": "scouted"},
            {"file": "Studio 107 (6).jpg", "source": "zen", "title": "Studio 107: Soundproof Film Production Soundstage & Overhead Lighting Grid", "cat": "scouted"},
            {"file": "Milstone Studios (3).jpg", "source": "zen", "title": "Milestone Studios: Flagship Acoustic Live Room with Grand Piano & ADR Suite", "cat": "scouted"},
            {"file": "Plug Studio (12).jpg", "source": "zen", "title": "Plug Studio: Professional Band Rehearsal & Multi-Track Audio Suite", "cat": "scouted"},
            {"file": "Suite Spot Studios (3).jpg", "source": "zen", "title": "Suite Spot Studios: Acoustic Mixing, Voiceover & Tracking Booth", "cat": "scouted"},
            {"file": "UCT-Rec Studio (8).jpg", "source": "zen", "title": "UCT Recording Studio: Symphonic Concert Acoustic Hall for Film Orchestras", "cat": "scouted"},
            {"file": "Forest Studio (7).jpg", "source": "zen", "title": "Forest Studio: Timber Acoustic Creative Studio in Natural Forest Setting", "cat": "scouted"},
            {"file": "Forest Studio (16).jpg", "source": "zen", "title": "Forest Studio: Creative Workspace & Rehearsal Lounge in Nature", "cat": "scouted"},
            {"file": "studio1_02.jpg", "source": "zen", "title": "Studio 1: White Infinity Cyclorama Soundstage for Controlled Set Builds", "cat": "scouted"}
        ]
    }
]

print("Encoding images...")
# Encode footer banner
footer_path = os.path.join(zen_dir, "Laura-Zen sign.png")
footer_b64 = encode_img(footer_path, max_size=(1600, 600), quality=85)
embedded_images["footer_banner"] = footer_b64
...
for cat in categories:
    ...
    for item in cat["gallery"]:
        fname = item["file"]
        stype = item["source"]
        fpath = get_file_path(fname, stype)
...
# Save encoded images to json cache to avoid re-encoding on every run
with open(os.path.join(web_dir, "embedded_data.json"), "w", encoding="utf-8") as f:
    json.dump({"images": embedded_images, "categories": categories}, f)

print("Saved embedded_data.json successfully!")
