...
function WhatsAppFloat() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Chat with SAL on WhatsApp"
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] px-5 py-3 text-background shadow-lg transition hover:scale-105 hover:shadow-xl"
    >
